...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------- | ----- | ----- | ---------------------------------------------- |
| [dot-files](https://github.com/2SSK/dot-files) | i3/sway dotfiles | QML | 247 | 9 | <span title="Jun 28, 2026">Today</span> |
...
| [autoupd](https://github.com/2SSK/autoupd) | A simple CLI too to automatically update system packages using your Linux distro's package manage... | Go | 7 | 0 | <span title="Jun 07, 2026">20 days ago</span> |
...
| [simple-temporal](https://github.com/2SSK/simple-temporal) | A production-ready Express.js API server with integrated Temporal workflow support, featuring aut... | TypeScript | 2 | 0 | <span title="Jun 02, 2026">26 days ago</span> |
