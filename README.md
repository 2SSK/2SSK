...
| ---------- | ----------- | ---------------- | ----- | ----- | ------------ |
| [dot-files](https://github.com/2SSK/dot-files) | i3/sway dotfiles | HTML | 199 | 9 | <span title="Sep 29, 2025">2 days ago</span> |
| [ansible-linux-system](https://github.com/2SSK/ansible-linux-system) | Ansible script to setup my linux system environment | Shell | 9 | 0 | <span title="Oct 01, 2025">Today</span> |
...
| [Threads](https://github.com/2SSK/Threads) | A React Native Threads clone | TypeScript | 0 | 0 | <span title="Sep 28, 2025">3 days ago</span> |
...
| [rust_ollama](https://github.com/2SSK/rust_ollama) | simple Rust library for Ollama intergration | Rust | 0 | 0 | <span title="Sep 09, 2025">22 days ago</span> |